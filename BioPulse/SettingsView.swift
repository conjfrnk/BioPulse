            ...
            VStack {
                ...
                GeometryReader { geometry in
                    ...
                    ZStack {
                        ...
                        // Gesture overlay to capture swipes over the entire carousel area
                        Rectangle()
                            .fill(Color.clear)
                            ...
                            .gesture(
                                DragGesture()
                                    ...
                                    .onEnded { value in
                                        // Estimate the final position using predictedEndTranslation
                                        let totalTranslation = value.translation.width + (value.predictedEndTranslation.width - value.translation.width)
                                        let predictedEndOffset = lastDragValue + totalTranslation

                                        // Calculate which item is closest to the predicted end position
                                        ...
                                        // Animate snapping to the selected item with inertia
